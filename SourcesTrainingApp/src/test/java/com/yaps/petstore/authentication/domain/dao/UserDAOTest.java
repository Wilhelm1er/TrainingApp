...
public class UserDAOTest {
    ...
    private void createCustomer(final String id) throws CreateException {
        ...
        customer.setAddress1("address1" + id);
        customer.setAddress2("address2" + id);
    ...
    private void checkCustomer(final User customer, final String id) {
        ...
        assertEquals("address1", "address1" + id, customer.getAddress1());
        assertEquals("address2", "address2" + id, customer.getAddress2());
