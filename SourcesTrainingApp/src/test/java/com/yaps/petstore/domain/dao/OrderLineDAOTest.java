...
import com.sport.training.domain.dao.OrderLineRepository;
...
import com.sport.training.domain.model.OrderLine;
...
//    	final Long id = Long.parseLong(counterService.getUniqueId(COUNTER_NAME));
    ...
    private long createOrderLine(final long id) throws CreateException {
        ...
        final Discipline category = new Discipline("cat" + categoryId, "name" + categoryId, "description" + categoryId);
        categoryRepository.save(category);
        // Create Product
    	String productId = counterService.getUniqueId("Product");
        final Activity product = new Activity("prod" + productId, "name" + productId, "description" + productId, category);
        productRepository.save(product);
        // Create Item
    	String itemId = counterService.getUniqueId("Item");
        final Event item = new Event("item" + itemId, "name" + itemId,_defaultDate, 1, product);
