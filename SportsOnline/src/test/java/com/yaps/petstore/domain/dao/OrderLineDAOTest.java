...
import com.train.sports.authentication.domain.dao.UserRepository;
...
import com.train.sports.domain.dao.OrderLineRepository;
...
import com.train.sports.domain.model.Order;
import com.train.sports.domain.model.OrderLine;
...
//    	final Long id = Long.parseLong(counterService.getUniqueId(COUNTER_NAME));
    ...
    private long createOrderLine(final long id) throws CreateException {
        ...
        final Item item = new Item("item" + itemId, "name" + itemId,_defaultDate, 1, product);
